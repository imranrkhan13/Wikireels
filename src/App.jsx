...
const COLOR_THEMES = [
  {
    name: "Warm Cream",
    bg: ["#F5F1E8", "#F7F3EA", "#F3EFE6", "#F8F4EB", "#F6F2E9"],
    text: ["#3E3E3E", "#424242", "#404040", "#3C3C3C", "#3A3A3A"],
    accent: "#8B5C4A",
    gradient: ["#EDE7DC", "#E3DCD0"],
    isDefault: true,
  },
  {
    name: "MIT Whisper",
    bg: ["#F1F8F6", "#F3FAF8", "#F0F7F5", "#F4FBF9", "#F2F9F7"],
    text: ["#2D3F38", "#2F4139", "#2E4038", "#2C3E37", "#2B3D36"],
    accent: "#4A8B7F",
    gradient: ["#E5F1ED", "#D9E8E3"],
    isPopular: true,
  },
  {
    name: "Soft Sage",
    bg: ["#F0F4F0", "#EEF2EE", "#EDF1ED", "#F1F5F1", "#EFF3EF"],
    text: ["#2C3E2C", "#2E402E", "#2D3F2D", "#2B3D2B", "#2A3C2A"],
    accent: "#5A7A5A",
    gradient: ["#E4EBE4", "#D8E3D8"],
  },
  {
    name: "Gentle Lavender",
    bg: ["#F5F3F8", "#F7F5FA", "#F4F2F7", "#F8F6FB", "#F6F4F9"],
    text: ["#3E3542", "#403744", "#3F3643", "#3D3441", "#3C3340"],
    accent: "#7B5E7B",
    gradient: ["#EBE7F0", "#DFD9E8"],
  },
  {
    name: "Peachy Blush",
    bg: ["#FFF5F0", "#FFF7F2", "#FFF4EF", "#FFF8F3", "#FFF6F1"],
    text: ["#4A3835", "#4C3A37", "#4B3936", "#493734", "#483633"],
    accent: "#C97A63",
    gradient: ["#FFEBE3", "#FFE0D4"],
  },
  {
    name: "Misty Blue",
    bg: ["#F0F5F8", "#F2F7FA", "#EFF4F7", "#F3F8FB", "#F1F6F9"],
    text: ["#2C3942", "#2E3B44", "#2D3A43", "#2B3841", "#2A3740"],
    accent: "#5B7C8E",
    gradient: ["#E4EDF2", "#D8E5EC"],
  },
  {
    name: "Ivory Linen",
    bg: ["#FAF8F3", "#FCFAF5", "#F9F7F2", "#FDFBF6", "#FBF9F4"],
    text: ["#3F3D35", "#413F37", "#403E36", "#3E3C34", "#3D3B33"],
    accent: "#8E7A5F",
    gradient: ["#F1EDE5", "#E8E2D7"],
  },
  {
    name: "Rose Quartz",
    bg: ["#F8F2F4", "#FAF4F6", "#F7F1F3", "#FBF5F7", "#F9F3F5"],
    text: ["#42363A", "#44383C", "#43373B", "#413539", "#403438"],
    accent: "#9E6B7B",
    gradient: ["#EFE6EA", "#E6DAE0"],
  },
  {
    name: "Warm Sand",
    bg: ["#F8F5F0", "#FAF7F2", "#F7F4EF", "#FBF8F3", "#F9F6F1"],
    text: ["#3E3933", "#403B35", "#3F3A34", "#3D3832", "#3C3731"],
    accent: "#A68A6E",
    gradient: ["#EFEAE3", "#E5DED4"],
  },
  {
    name: "Cool Concrete",
    bg: ["#F3F4F5", "#F5F6F7", "#F2F3F4", "#F6F7F8", "#F4F5F6"],
    text: ["#353739", "#373941", "#363840", "#34363E", "#33353D"],
    accent: "#6B7280",
    gradient: ["#E7E9EA", "#DDE0E2"],
  },
  {
    name: "Dusty Rose",
    bg: ["#F9F4F6", "#FBF6F8", "#F8F3F5", "#FCF7F9", "#FAF5F7"],
    text: ["#453A3E", "#473C40", "#463B3F", "#44393D", "#43383C"],
    accent: "#B88A9A",
    gradient: ["#F0E9ED", "#E7DFE5"],
  },
  {
    name: "Seafoam Dream",
    bg: ["#F0F9F7", "#F2FBF9", "#EFF8F6", "#F3FCF9", "#F1FAF8"],
    text: ["#2E3F3A", "#30413C", "#2F403B", "#2D3E39", "#2C3D38"],
    accent: "#6BA39C",
    gradient: ["#E4F1EE", "#D8E8E4"],
  },
  {
    name: "Amber Glow",
    bg: ["#FBF7F0", "#FDFAF2", "#FCF8F1", "#FEF9F3", "#FDF8F1"],
    text: ["#4B4033", "#4D4235", "#4C4134", "#4A3F32", "#493E31"],
    accent: "#C9A557",
    gradient: ["#F4EDDF", "#EBDFD0"],
  },
  {
    name: "Slate Mist",
    bg: ["#F2F3F5", "#F4F5F7", "#F1F2F4", "#F5F6F8", "#F3F4F6"],
    text: ["#343638", "#363840", "#35373F", "#33353D", "#32343C"],
    accent: "#6B7A8A",
    gradient: ["#E6E8EB", "#DCDFE4"],
  },
  {
    name: "Blush Pearl",
    bg: ["#FCF6F7", "#FEF8F9", "#FBF5F6", "#FFF9FA", "#FDF7F8"],
    text: ["#4E3A3D", "#503C3F", "#4F3B3E", "#4D393C", "#4C383B"],
    accent: "#D4909F",
    gradient: ["#F5ECEF", "#ECE2E7"],
  },
];
      ...
      <div className="w-full max-w-xs sm:max-w-2xl md:max-w-4xl h-[88vh] sm:h-[85vh] md:h-[90vh]">
        ...
        >
            ...
            <div className="flex items-start justify-between gap-3 sm:gap-4">
              <div className="flex-1 min-w-0" style={{ pointerEvents: "auto" }}>
                ...
                <motion.h2
                  ...
                  className="text-base sm:text-lg md:text-2xl lg:text-3xl xl:text-4xl font-bold leading-tight tracking-tight"
                  style={{
                    color: textColor,
                    userSelect: "text",
              ...
              <motion.div
                ...
                className="flex items-center gap-2 sm:gap-2.5 flex-shrink-0 pointer-events-auto"
              >
                <AnimatedButton
                    ...
                    {showShareMenu && (
                      ...
                      >
                        <button
                          ...
                          className="w-full px-4 py-3 text-left text-sm font-medium hover:bg-black/5 flex items-center gap-2.5 transition-colors"
            ...
            >
              {article.imageUrl && (
                <motion.div
                  ...
                  className="w-1/3 sm:w-2/5 md:w-2/5 lg:w-1/3 float-right ml-2 sm:ml-4 md:ml-5 mb-2 sm:mb-3 md:mb-4"
                >
                  <div
                    className="relative aspect-[4/3] rounded-lg sm:rounded-2xl overflow-hidden shadow-lg border"
                    style={{
              ...
              >
                ...
                >
                  <p
                    className="text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed font-normal opacity-90"
                    style={{
                      color: textColor,
                      pointerEvents: "auto",
                      userSelect: "text",
          ...
          <motion.div
            ...
            className="relative z-20 flex-shrink-0 p-3 sm:p-4 md:p-6 lg:p-8 pt-1.5 sm:pt-2 md:pt-3 border-t"
          ...
          >
            <motion.a
              ...
              className="inline-flex items-center gap-2 text-xs sm:text-sm md:text-base font-bold group"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    >
                      ...
                      {savedArticlesList.length === 1 ? "article" : "articles"}
                      saved
                    </motion.p>
                  </div>
                  <motion.button
              ...
              style={{
                backgroundColor:
                  savedArticlesList.length > 0
                    ? theme.accent
                    : `${theme.accent}12`,
                color: savedArticlesList.length > 0 ? "#FFFFFF" : theme.accent,
              }}
            />
            <AnimatedButton
